...
namespace Client.Adition
{
    public class CommandHandler
    {
        ...
        public List<IMyCommand> undoCommands = new List<IMyCommand>();
        public List<IMyCommand> redoCommands = new List<IMyCommand>();
        ...
        public void Redo()
        {
            ...
            {
                redoCommands[redoCommands.Count - 1].MyExecute(redoObjects[redoObjects.Count - 1]);
        ...
        public void Undo()
        {
            ...
            {
                undoCommands[undoCommands.Count - 1].MyUnexecute(undoObjects[undoObjects.Count - 1]);
